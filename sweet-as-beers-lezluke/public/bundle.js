...
var _reduce_nav = __webpack_require__(69);

var _reduce_nav2 = _interopRequireDefault(_reduce_nav);

var _cart_reducer = __webpack_require__(70);
...
exports.default = (0, _redux.combineReducers)({
  navReducer: _reduce_nav2.default,
  addCart: _cart_reducer2.default
});
...
exports.default = function () {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'showListing';
    var action = arguments[1];
...
exports.default = function () {
    ...
    switch (action.type) {
        ...
        case "UPDATE_CART":
            var index = state.findIndexA(function (item) {
                return item.id === action.id;
            });
            if (index > -1) {
...
var _Listing = __webpack_require__(72);
...
var App = function App(props) {
  return _react2.default.createElement(
    ...
    props.showListing === 'showListing' ? _react2.default.createElement(_Listing2.default, null) : _react2.default.createElement(_Cart2.default, null)
  );
};
...
var _beers = __webpack_require__(73);

var _beers2 = _interopRequireDefault(_beers);

var _BeerList = __webpack_require__(74);
    ...
    _createClass(Listing, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_BeerList2.default, { beer: _beers2.default.beers })
            );
        }
    }]);
...
var _BeerListItem = __webpack_require__(75);
...
var BeerList = function BeerList(props) {
  return _react2.default.createElement(
    'div',
    null,
    props.beer.map(function (beer) {
      return _react2.default.createElement(
        'div',
        { key: beer.id },
        _react2.default.createElement(_BeerListItem2.default, { addToCart: props.addToCart, id: beer.id, name: beer.name, brewery: beer.brewery, style: beer.style, country: beer.country, abv: beer.abv })
      );
    })
  );
};
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    addToCart: function addToCart(id, name) {
      dispatch((0, _index.addToCart)(id, name));
      dispatch((0, _index.navigate)('cart'));
    }
  };
};

exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(BeerList);
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        { onClick: function onClick() {
            props.addToCart(props.id, props.name);
          }, className: "cart-link" },
        "Add to cart"
      )
    )
...
var updateItem = exports.updateItem = function updateItem(id) {
  return {
    type: 'UPDATE_CART',
    id: id
  };
...
var _CartList = __webpack_require__(79);
...
var Cart = function (_Component) {
    ...
    function Cart(props) {
        ...
        _this.state = {
            cart: _this.props.addCart
        };
        _this.updatesItem = _this.updatesItem.bind(_this);
    ...
    _createClass(Cart, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_CartList2.default, { returnToListing: this.props.returnToListing, cart: this.state.cart, updatesItem: this.updatesItem, deleteItem: this.props.deleteItem, submitUpdate: this.submitUpdate })
            );
        }
    }, {
        key: 'updatesItem',
        value: function updatesItem(id, quantity) {
            console.log(id);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    return {
        returnToListing: function returnToListing() {
            dispatch((0, _index.navigate)('showListing'));
        },
        deleteItem: function deleteItem(id) {
            dispatch((0, _index.deleteItem)(id));
        },
        updateItem: function updateItem(cart) {
            console.log('hit');

            dispatch((0, _index.updateItem)(cart));
        }
    };
};
...
var _CartListItem = __webpack_require__(80);
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        'tbody',
        null,
        props.cart.map(function (cartItem) {
          return _react2.default.createElement(_CartListItem2.default, { name: cartItem.name, quantity: cartItem.quantity, id: cartItem.id, updatesItem: props.updatesItem, deleteItem: props.deleteItem });
        })
      )
    ),
    _react2.default.createElement(
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        "td",
        null,
        _react2.default.createElement("input", { className: "update-input", onChange: function onChange(e) {
            return props.updatesItem(props.id, e.target.value);
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          "button",
          null,
          _react2.default.createElement("span", { className: "fa fa-trash fa-2x", onClick: function onClick() {
